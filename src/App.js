  ...
  return (
    <Router>
      <div className="flex min-h-screen max-w-[100vw] overflow-x-hidden bg-white font-sans">
        ...
        <main className={`w-full max-w-[100vw] flex-1 overflow-x-hidden p-4 pb-[calc(8rem+env(safe-area-inset-bottom))] transition-all duration-300 md:p-10 ${collapsed ? 'md:ml-20' : 'md:ml-64'}`}>
          <Routes>
